        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://embed.tawk.to https://*.sentry.io; style-src 'self' 'unsafe-inline'; img-src * data:; font-src 'self' data:; connect-src *;",
          },
          {
