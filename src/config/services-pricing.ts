...
//
// Produit "Rencontre Premium" (prod_Txa04zZwioxjnv). Les 3 Price dédiés existent
// dans Stripe (live), créés le 2026-07-03 via l'API :
//   - month     : 19.99€/mois          (price_1SzetvRxqcfmHXQYHVh9NIMU)
//   - trimester : 44.97€/3 mois (14.99€/mois, interval_count=3)  price_1Toz0jRxqcfmHXQYKMcxBiBN
//   - semester  : 59.94€/6 mois (9.99€/mois, interval_count=6)   price_1Toz0kRxqcfmHXQYo8onCCnL
// Chaque plan facture désormais le bon montant selon la durée choisie.
...
export const DATING_PREMIUM_PLANS: Record<DatingPremiumPlan, { priceId: string; durationDays: number }> = {
  ...
  trimester: { priceId: 'price_1Toz0jRxqcfmHXQYKMcxBiBN', durationDays: 90 },
  semester: { priceId: 'price_1Toz0kRxqcfmHXQYo8onCCnL', durationDays: 180 },
};
