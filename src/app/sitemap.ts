...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    { url: `${BASE_URL}/`, lastModified: new Date().toISOString(), changeFrequency: 'yearly', priority: 1 },
    { url: `${BASE_URL}/actualites-sur-les-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE_URL}/meilleurs-plans-aux-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE_URL}/vivre-aux-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/voyager-aux-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/forum-sur-les-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'daily', priority: 0.9 },
    { url: `${BASE_URL}/marketplace-aux-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'daily', priority: 0.9 },
    { url: `${BASE_URL}/rencontre-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'daily', priority: 0.9 },
    { url: `${BASE_URL}/application-mobile`, lastModified: new Date().toISOString(), changeFrequency: 'yearly', priority: 0.5 },
    { url: `${BASE_URL}/cgu`, lastModified: new Date().toISOString(), changeFrequency: 'yearly', priority: 0.3 },
    { url: `${BASE_URL}/confidentialite`, lastModified: new Date().toISOString(), changeFrequency: 'yearly', priority: 0.3 },
    { url: `${BASE_URL}/mentions-legales`, lastModified: new Date().toISOString(), changeFrequency: 'yearly', priority: 0.3 },
    { url: `${BASE_URL}/connexion`, lastModified: new Date().toISOString(), changeFrequency: 'yearly', priority: 0.5 },
    { url: `${BASE_URL}/itineraire-personnalise-pour-les-philippines`, lastModified: new Date().toISOString(), changeFrequency: 'monthly', priority: 0.7 },
  ];
